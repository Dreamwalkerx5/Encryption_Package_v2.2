...
public class Encryption {
    ...
    /**
     * This class is used to create an Encryption.Encryption instance, you should provide ALL data or start
    ...
    public static class Builder {
         ...
         * the default base mode is Encryption.Base64
        ...
        /**
         * Build the Encryption.Encryption with the provided information
         *
         * @return a new Encryption.Encryption instance with provided information
         *
